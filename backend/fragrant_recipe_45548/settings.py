"""
Django settings for fragrant_recipe_45548 project.
...
ROOT_URLCONF = 'fragrant_recipe_45548.urls'
...
WSGI_APPLICATION = 'fragrant_recipe_45548.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fragrant_recipe_45548 API",
    "DESCRIPTION": "API documentation for fragrant_recipe_45548 App",
    "VERSION": "v1",
}
